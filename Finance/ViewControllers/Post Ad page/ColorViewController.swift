...
class ColorViewController: UIViewController {
    ...
    let lblArr = ["Yellow","Black","Purple","Red","Blue","Green","Orange","Green","Beige","Grey"]
...
extension ColorViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if indexPath.row == 0 {
            let main = storyboard?.instantiateViewController(withIdentifier: "OwnerViewController") as! OwnerViewController
