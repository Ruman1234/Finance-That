//
//  TransmisssionViewController.swift
//  Finance
//
...
class TransmisssionViewController: UIViewController {

    @IBOutlet weak var transmissionCollectionView: UICollectionView!
    
    let lblArr = ["Automatic","Manual"]

    override func viewDidLoad() {
        super.viewDidLoad()
        transmissionCollectionView.delegate = self
        transmissionCollectionView.dataSource = self
    }
...
extension TransmisssionViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension TransmisssionViewController: UICollectionViewDelegateFlowLayout {
